...
export const siteContent: Record<Locale, SiteContent> = {
  ...
  zh: {
    ...
    profile: {
      ...
      github: "https://github.com/gdshjzm",
      resumeHref: "/zhang-busheng-resume.pdf",
      interests: ["AI for Science", "AI Agent", "强化学习", "知识图谱", "图基础模型"],
    },
    stats: [
      {
        label: "专业排名",
      ...
      },
      {
        label: "竞赛荣誉",
        value: "国家级 / 省级奖项",
        note: "物理实验、机器人与数学建模等方向",
        accent: "green",
      },
      {
        label: "科研项目",
        value: "3+ 项",
        note: "GraphLLM、Pix2Pix 与 SciAtlas",
        accent: "orange",
      },
    ],
    education: [
      {
        ...
        period: "2023.09 - 2027.06",
        highlights: [
          "核心课程：Design & Build（100）、Numerical Solutions of Differential Equations（98）、Introduction to Artificial Intelligence（95）、Mathematical Modeling（94）、Probability and Statistics（93）。",
          "科研实习导师：石川、张宁豫。",
          "政治面貌：中共预备党员。",
    ...
    researchItems: [
      {
        ...
        role: "科研实习",
        period: "2024.07 - 至今",
        organization: "北京邮电大学 GammaLab",
        tags: ["GraphLLM", "鲁棒性", "多模态防御"],
        bullets: [
          "围绕图语言模型的对抗鲁棒性开展研究，目标是在表示能力与防御能力之间取得平衡。",
          "将受 CLIP 类多模态模型启发的防御策略引入图语言模型场景，包括 TeCoA、PMG 等方法，相比传统基线取得约 21% 的提升。",
          "在对抗数据集上的初步实验已将攻击成功率降低约 15%，相关工作仍在持续推进。",
        ],
      },
      {
        title: "AI-Signaturer: AI Automatic Signature Generation Based on Pix2pix",
      ...
      },
      {
        ...
        role: "共同作者",
        period: "2025",
        organization: "与浙江大学 ZJNLP 实验室合作",
        link: "https://arxiv.org/abs/2605.22878",
        tags: ["知识图谱", "神经符号检索", "AI for Science"],
        bullets: [
          "参与构建大规模跨学科学术知识图谱，覆盖 26 个学科、4300 余万篇论文、1.57 亿实体与 30 亿三元组。",
          "参与设计神经符号检索流程，将关键词匹配、语义向量召回与基于 Random Walk with Restart 的图传播结合起来，实现协同召回与图重排序。",
          "技术报告已发布于 arXiv，开源仓库累计获得 130+ GitHub stars。",
        ],
      },
    ],
    projectItems: [
      ...
      {
        title: "伦敦创新营：面向目标感知的机械臂抓取",
        period: "2026.01 - 2026.02",
        tags: ["ROS", "Gazebo", "机器人"],
        bullets: [
          "入选学校资助的 Winterhack 项目，与伦敦、北京、海南多地同学协作完成机器人系统设计。",
